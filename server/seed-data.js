...
function defaultContent() {
  return {
    ...
    products: [
      ...
      { id: 3, category: 'eyeglasses', brand: 'Prada', name: 'PR 17WS Symbole', amount: 1290, original: 0, rating: 4.5, reviews: 41, badge: { variant: 'bestseller', label: { en: 'Bestseller', he: 'רב מכר' } }, tryMirror: true, colors: ['#1A1A17', '#7E4310'], shape: 'Cat-eye', material: 'Acetate', gender: 'Women', image: '', tryMirrorModel: { '#1A1A17': '/tryon/models/demo-frame.glb' }, tryMirrorMeta: { modelForwardAxis: 'z', scaleMultiplier: 1.0, bridgeYOffset: 0, frameRealWidthMm: 118 } },

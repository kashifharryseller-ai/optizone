...
const STRINGS = {
  en: {
    ...
    account: {
      ...
      password: 'Password', sms: 'SMS code',
      email: 'Email address', phone: 'Phone · 05X-XXX-XXXX', pw: 'Password',
      signin: 'Sign in', sendCode: 'Send code', or: 'or',
      google: 'Continue with Google', create: 'Create an account',
      protected: 'Protected sign-in · rate-limited · IS 5568 accessible',
      myAccount: 'My account', hello: 'Shalom, Maya',
      stats: { orders: 'Orders', rx: 'Prescriptions', looks: 'Saved looks', appts: 'Appointments' },
      tabs: { orders: 'Orders', rx: 'Prescriptions', looks: 'Saved Looks', wishlist: 'Wishlist' },
      track: 'Track',
      od: 'OD (right)', os: 'OS (left)', pd: 'PD',
      valid: (e) => `Valid → ${e}`, useOnOrder: 'Use on new order', downloadPdf: 'Download PDF',
      addRx: 'Add a prescription (upload or manual)',
    },
  ...
  he: {
    ...
    account: {
      ...
      password: 'סיסמה', sms: 'קוד ב-SMS',
      email: 'כתובת אימייל', phone: 'טלפון · 05X-XXX-XXXX', pw: 'סיסמה',
      signin: 'התחברות', sendCode: 'שליחת קוד', or: 'או',
      google: 'המשך עם Google', create: 'פתיחת חשבון',
      protected: 'התחברות מאובטחת · מוגבלת קצב · נגיש לפי ת״י 5568',
      myAccount: 'החשבון שלי', hello: 'שלום, מאיה',
      stats: { orders: 'הזמנות', rx: 'מרשמים', looks: 'לוקים שמורים', appts: 'תורים' },
      tabs: { orders: 'הזמנות', rx: 'מרשמים', looks: 'לוקים שמורים', wishlist: 'מועדפים' },
      track: 'מעקב',
      od: 'ימין (OD)', os: 'שמאל (OS)', pd: 'מרחק אישונים',
      valid: (e) => `בתוקף → ${e}`, useOnOrder: 'שימוש בהזמנה חדשה', downloadPdf: 'הורדת PDF',
      addRx: 'הוספת מרשם (העלאה או ידני)',
    },
